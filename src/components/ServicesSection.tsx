      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <h2 className="font-display text-4xl md:text-6xl text-foreground mt-2 mb-4">
            ...
            <span className="text-gradient">SUA OBRA</span>
          </h2>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {services.map((service, index) => (
            <div
              key={service.title}
              className="group bg-card border border-border rounded-2xl p-8 hover:border-secondary/50 hover:shadow-card transition-all duration-300 hover:-translate-y-1"
