  ...
  return (
    <section id="inicio" className="relative min-h-screen flex items-center bg-hero overflow-hidden">
      ...
      <div className="absolute inset-0">
        <img
          src={heroImage}
          alt="Serviços de construção e instalação elétrica"
      ...
      <div className="container mx-auto px-4 py-32 relative z-10">
        <div className="max-w-4xl">
          ...
          <h1 className="font-display text-5xl md:text-7xl lg:text-8xl text-primary-foreground leading-none mb-6 animate-fade-in" style={{ animationDelay: "0.1s" }}>
            CONSTRUÇÃO &{" "}
            <span className="text-gradient">INSTALAÇÃO ELÉTRICA</span>
          </h1>

          <p className="text-xl md:text-2xl text-primary-foreground/70 max-w-2xl mb-8 animate-fade-in" style={{ animationDelay: "0.2s" }}>
          ...
          <div className="flex flex-wrap gap-4 animate-fade-in" style={{ animationDelay: "0.4s" }}>
            {features.map(({ icon: Icon, label }) => (
              <div
                key={label}
                className="flex items-center gap-2 bg-primary-foreground/5 border border-primary-foreground/10 rounded-full px-4 py-2"
              >
